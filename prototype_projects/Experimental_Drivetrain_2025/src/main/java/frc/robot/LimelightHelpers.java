...
public class LimelightHelpers {
  ...
  private static PoseEstimate getBotPoseEstimate(
    ...
    DoubleArrayEntry poseEntry = LimelightHelpers.getLimelightDoubleArrayEntry(
      limelightName,
      entryName
    );
  ...
  public static RawFiducial[] getRawFiducials(String limelightName) {
    var entry = LimelightHelpers.getLimelightNTTableEntry(
      limelightName,
      "rawfiducials"
    );
  ...
  public static void printPoseEstimate(PoseEstimate pose) {
    ...
    for (int i = 0; i < pose.rawFiducials.length; i++) {
      ...
      System.out.printf(
        "  Distance to Camera: %.2f meters%n",
        fiducial.distToCamera
      );
      System.out.printf(
        "  Distance to Robot: %.2f meters%n",
  ...
  public static Boolean validPoseEstimate(PoseEstimate pose) {
    return (
      pose != null && pose.rawFiducials != null && pose.rawFiducials.length != 0
    );
  }
  ...
  public static String[] getLimelightNTStringArray(
    String tableName,
    String entryName
  ) {
    return getLimelightNTTableEntry(tableName, entryName).getStringArray(
      new String[0]
    );
  }
   ...
   */
  public static void SetFiducialIDFiltersOverride(
    String limelightName,
    int[] validIDs
  ) {
   ...
   */
  public static void SetFiducialDownscalingOverride(
    String limelightName,
    float downscale
  ) {
    int d = 0; // pipeline
