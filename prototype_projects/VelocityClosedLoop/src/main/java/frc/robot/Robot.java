...
public class Robot extends TimedRobot {
  ...
  public Robot() {
    ...
    // Peak output of 40 A
    configs.TorqueCurrent.withPeakForwardTorqueCurrent(
      Amps.of(40)
    ...
    m_fllr.setControl(
      new Follower(m_fx.getDeviceID(), MotorAlignmentValue.Aligned)
    );
  ...
  public void teleopPeriodic() {
    ...
    if (m_joystick.getLeftBumperButton()) {
      ...
      m_fx.setControl(
        m_velocityVoltage.withVelocity(desiredRotationsPerSecond)
      );
