...
public final class Constants {
  ...
  public static class LauncherConstants {
    ...
    public static final double kV = (12.0/40000.0); // (12.0/5767); // Copied from basic REV example!
    public static final double kCruiseVelocityRPM = 5000.0;
    public static final double kAllowedErrorR = 1.0;
