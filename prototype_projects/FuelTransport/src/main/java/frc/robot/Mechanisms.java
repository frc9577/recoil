...
public class Mechanisms {
  ...
  MechanismLigament2d midline = mech
    ...
    .append(
      new MechanismLigament2d("midline", 0.1, 0, 3, new Color8Bit(Color.kCyan))
    );
  ...
  MechanismLigament2d arm = mech
    ...
    .append(
      new MechanismLigament2d("arm", .2, 0, 0, new Color8Bit(Color.kAliceBlue))
    );

  MechanismLigament2d side1 = arm.append(
    new MechanismLigament2d(
      "side1",
      0.15307,
      112.5,
  ...
  MechanismLigament2d side2 = side1.append(
    new MechanismLigament2d(
      "side2",
      0.15307,
      45,
  ...
  MechanismLigament2d side3 = side2.append(
    new MechanismLigament2d(
      "side3",
      0.15307,
      45,
  ...
  MechanismLigament2d side4 = side3.append(
    new MechanismLigament2d(
      "side4",
      0.15307,
      45,
  ...
  MechanismLigament2d side5 = side4.append(
    new MechanismLigament2d(
      "side5",
      0.15307,
      45,
  ...
  MechanismLigament2d side6 = side5.append(
    new MechanismLigament2d(
      "side6",
      0.15307,
      45,
  ...
  MechanismLigament2d side7 = side6.append(
    new MechanismLigament2d(
      "side7",
      0.15307,
      45,
  ...
  MechanismLigament2d side8 = side7.append(
    new MechanismLigament2d(
      "side8",
      0.15307,
      45,
