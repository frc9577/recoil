...
public class AutoCommands {
    public static ArrayList<String> getPathNames() {
        ...
        File deployDirectory = new File(deployDirectoryPath+"/pathplanner/paths");
        ...
        if (listOfFiles != null) {
            for (File file : listOfFiles) {
                ...
                if (file.isFile()) {
                    ...
                    if (splitName.length > 1 && "path".equals(splitName[1])) {
                        pathNames.add(splitName[0]);
                        System.out.println("FOUND PATH: "+splitName[0]);
                    }
                }
            }
        }
