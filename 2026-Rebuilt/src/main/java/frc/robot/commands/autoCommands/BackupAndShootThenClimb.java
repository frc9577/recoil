...
public class BackupAndShootThenClimb extends Command {
   ...
   */
  public BackupAndShootThenClimb(DriveSubsystem driveSubsystem, DifferentialDrivePoseEstimator poseEstimator, BooleanSupplier isRed, PathConstraints constraints) {
