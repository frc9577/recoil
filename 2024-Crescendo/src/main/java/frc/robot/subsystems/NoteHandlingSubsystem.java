...
public class NoteHandlingSubsystem extends SubsystemBase {
  ...
  private final CANSparkMax m_intakeMotor = new CANSparkMax(
    NoteHandlingConstants.kIntakeMotorCANID,
    MotorType.kBrushless
  );
  private final CANSparkMax m_outputMotor = new CANSparkMax(
    NoteHandlingConstants.kOutputMotorCANID,
    MotorType.kBrushless
  );

  private final DigitalInput m_noteSensor = new DigitalInput(
    NoteHandlingConstants.kNoteSensorChannel
  );

  /** Creates a new NoteHandlingSubsystem. */
  public NoteHandlingSubsystem() {
    m_intakeMotor.setSmartCurrentLimit(
      NoteHandlingConstants.kIntakeCurrentLimit
    );
    m_outputMotor.setSmartCurrentLimit(
      NoteHandlingConstants.kOutputCurrentLimit
    );
  }
