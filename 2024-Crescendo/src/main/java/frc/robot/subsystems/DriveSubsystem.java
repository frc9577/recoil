...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final TalonFX m_leftFrontMotor = new TalonFX(
    DrivetrainConstants.kLeftFrontMotorCANID
  );
  private final TalonFX m_leftBackMotor = new TalonFX(
    DrivetrainConstants.kLeftBackMotorCANID
  );
  private final TalonFX m_rightFrontMotor = new TalonFX(
    DrivetrainConstants.kRightFrontMotorCANID
  );
  private final TalonFX m_rightBackMotor = new TalonFX(
    DrivetrainConstants.kRightBackMotorCANID
  );
  ...
  public DriveSubsystem() {
    ...
    m_leftBackMotor.setControl(
      new Follower(m_leftFrontMotor.getDeviceID(), false)
    );
    m_rightBackMotor.setControl(
      new Follower(m_rightFrontMotor.getDeviceID(), false)
    );
  ...
  public void setTankSpeeds(double leftInput, double rightInput) {
    ...
    m_rightSpeed = m_driveStraight
      ? m_leftSpeed
      : (rightInput / m_speedDivider) * m_modeMultiplier;
